...
function AdminSettingsPage() {
    ...
    const handleSave = async (e: React.FormEvent) => {
        e.preventDefault()
        await updateSetting.mutateAsync({ key: "sender_email", value: senderEmail })
    ...
    return (
        <div className="space-y-6">
            <div>
                ...
                <p className="text-[#1E1B4B]/60 mt-1">Configure global application settings and email delivery.</p>
            </div>
            ...
            <div className="grid gap-6 lg:grid-cols-2">
                <Card className="border-[#6366F1]/10 bg-white">
                    <CardHeader>
                        ...
                        <CardDescription>
                            Configure the sender address and organization name for all outgoing emails.
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
                        <form onSubmit={handleSave} className="space-y-4">
                            ...
                            <div className="space-y-2">
                                ...
                                <p className="text-xs text-[#1E1B4B]/50">
                                    Important: This email must be from a domain verified in your Resend dashboard.
                                </p>
                            </div>
                            <Button
                                type="submit"
                ...
                <Card className="border-[#6366F1]/10 bg-white">
                    ...
                    <CardContent className="space-y-4 text-sm text-[#1E1B4B]/70">
                        <div className="rounded-lg bg-[#6366F1]/5 p-4 space-y-3">
                            <h4 className="font-semibold text-[#1E1B4B]">Domain Verification</h4>
                            <ol className="list-decimal pl-4 space-y-2">
                                <li>Go to the <a href="https://resend.com/domains" target="_blank" rel="noreferrer" className="text-[#6366F1] hover:underline inline-flex items-center gap-1">Resend Dashboard <ExternalLink className="h-3 w-3" /></a></li>
                                <li>Add your domain (e.g., <code>itimedit.com</code>)</li>
                        ...
                        <div className="rounded-lg bg-amber-50 p-4 space-y-3 border border-amber-100">
                            <h4 className="font-semibold text-amber-900">Configuring the App</h4>
                            <p>Once verified, enter an email from that domain (e.g., <code>hello@itimedit.com</code>) in the form to the left.</p>
                            <p className="text-xs text-amber-700">Note: Sending from unverified domains will cause delivery failures.</p>
                        </div>
                    </CardContent>
                </Card>
            </div>
