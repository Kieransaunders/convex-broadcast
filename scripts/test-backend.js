...
if (!CONVEX_URL) {
  console.error(
    "❌ Error: VITE_CONVEX_URL or CONVEX_URL environment variable required",
  );
  console.error(
    "   Example: VITE_CONVEX_URL=https://your-deployment.convex.cloud node scripts/test-backend.js",
  );
  process.exit(1);
}
