...
description: Seamlessly integrate Better Auth with Convex databases for modern authentication patterns in full-stack TypeScript applications. Use when working with auth features, Better Auth.
---
